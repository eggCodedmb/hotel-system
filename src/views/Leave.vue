    ...
    <div class="leave-approval-container">
            ...
            <el-row :gutter="20">
                <el-col :span="6">
                    <el-form-item label="申请人">
                        <el-input v-model="searchForm.applicant" placeholder="请输入姓名" clearable />
                    </el-form-item>
                </el-col>
                <el-col :span="6">
        ...
        <c-table :columns="columns" :data="tableData" :total="total" v-model:current-page="currentPage"
            ...
            <template #action="{ row }">
                ...
                <el-button v-if="row.status === 0" type="success" size="small" @click="handleApprove(row, 1)">
                    通过
                </el-button>
                <el-button v-if="row.status === 0" type="danger" size="small" @click="handleApprove(row, 2)">
                    拒绝
                </el-button>
            </template>
        </c-table>
        ...
        <!-- 审批对话框 -->
        <el-dialog v-model="dialogVisible" :title="`审批详情 - ${currentRow?.applicant}`" width="40%">
            <el-descriptions :column="1" border>
                ...
                <el-descriptions-item label="请假事由">{{ currentRow?.reason }}</el-descriptions-item>
                <el-descriptions-item label="附件">
                    <el-link v-if="currentRow?.attachment" :href="currentRow.attachment" target="_blank">
                        下载附件
                    </el-link>
                </el-descriptions-item>
            </el-descriptions>
